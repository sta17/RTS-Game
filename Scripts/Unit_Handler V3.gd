...
var selected:bool = false:
	set(new_value):
		spr_selected.selected = new_value
...
func _ready() -> void:
	...
	healthbar.MAXHP = unit_data.hp
	
	attackTimer.setAttackCOOLDOWN(unit_data.attack_cooldown)
	attackTimer.setAttackDamage(unit_data.attack)
